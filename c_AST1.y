...
struct AST* make_do_node(char* root, AST_node* child1, AST_node* child2);
...
%token DOT SINGLE SC  COMMA LETTER  OPBRACE CLBRACE CONTINUE BREAK IF ELSE FOR WHILE DO POW OPEN CLOSE COMMENT 
...
C   : CASE NUM COLON stat      {$$=make_node("Case",$2,$4);}
	| CASE ALPHA COLON stat      {$$=make_node("Case",$2,$4);}
    ;
...
iter_stat:DO comp_stat WHILE OPEN cond CLOSE SC	{$$=make_do_node("do",$2,$5);}
		 ;
